...
<html>
    ...
    <body>
        ...
        <h5>En vigueur au 06/04/2021</h5>

        <p class="cgu" >Les présentes conditions générales d'utilisation (dites « CGU ») ont pour objet l'encadrement juridique
            ...
            diaghealth.com se réserve le droit de modifier unilatéralement et à tout moment le contenu des
            présentes CGU.</p>

        <h2>Article 1 : Les mentions légales</h2>

        <p class="cgu">L’édition et la direction de la publication du site diaghealth.com est assurée par APP G7B, domicilié 28
            Rue Notre Dame des Champs.
            Numéro de téléphone est _______________
            Adresse e-mail diaghealth@gmail.com.
            L'hébergeur du site diaghealth.com est la société _______________, dont le siège social est situé au
            _______________, avec le numéro de téléphone : _______________.</p>

        <h2>ARTICLE 2 : Accès au site</h2>

        <p class="cgu">Le site diaghealth.com permet à l'Utilisateur un accès gratuit aux services suivants :
            Le site internet propose les services suivants :
            accès aux résultats d'analyses de tests psychotechniques.
            ...
            la responsabilité de diaghealth.com. Dans ces cas, l’Utilisateur accepte ainsi ne pas tenir rigueur à
        ...
        <p class="cgu">Le site est exempté de déclaration à la Commission Nationale Informatique et Libertés (CNIL) dans la
            mesure où il ne collecte aucune donnée concernant les Utilisateurs.</p>

        <h2>ARTICLE 4 : Propriété intellectuelle</h2>

        <p class="cgu">Les marques, logos, signes ainsi que tous les contenus du site (textes, images, son…) font l'objet
        ...
        <p class="cgu">Les sources des informations diffusées sur le site diaghealth.com sont réputées fiables mais le site ne
            ...
            Malgré des mises à jour régulières, le site diaghealth.com ne peut être tenu responsable de la
            ...
            Le site diaghealth.com ne peut être tenu pour responsable d’éventuels virus qui pourraient infecter
        ...
        <p class="cgu">Des liens hypertextes peuvent être présents sur le site. L’Utilisateur est informé qu’en cliquant sur ces
            liens, il sortira du site diaghealth.com. Ce dernier n’a pas de contrôle sur les pages web sur lesquelles
            aboutissent ces liens et ne saurait, en aucun cas, être responsable de leur contenu.</p>

        <h2>ARTICLE 7 : Cookies</h2>

        <p class="cgu">L’Utilisateur est informé que lors de ses visites sur le site, un cookie peut s’installer automatiquement
            ...
            l’Utilisateur par votre navigateur et qui sont nécessaires à l’utilisation du site diaghealth.com. Les
            ...
            L’information contenue dans les cookies est utilisée pour améliorer le site diaghealth.com.
        ...
        <p class="cgu">Le site permet aux membres de publier les contenus suivants :
            forum.
        ...
        <p class="cgu">La législation française s'applique au présent contrat. En cas d'absence de résolution amiable d'un
