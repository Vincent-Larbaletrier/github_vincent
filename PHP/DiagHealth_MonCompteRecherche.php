...
if($_SESSION['connexion'] != '1' || $_SESSION['role'] == 'Utilisateur' || $_GET['id_user'] == '') {
	...
	if(isset($_POST['supprim'])){
		...
		header('Location: DiagHealth_gestion_admin.php');
	}
...
<html>
	<head>
		<title>Recherche d'un compte</title>
		<meta charset="utf-8">
	...
	<body>
		...
		<h1> Compte / informations personnelles de <?= $dataCompte['prenom']; ?></h1>
			...
			<?php if($_SESSION['role'] == 'Administrateur') {
				...
				<div id="bouton">
					<form id="ajouter" name="ajouter" method="post">
						<input type="submit" class="supprim" name="supprim" onclick="return confirmDelete()" value="Supprimer cette utilisateur">
					</form>
				</div>
				<?php
			}
