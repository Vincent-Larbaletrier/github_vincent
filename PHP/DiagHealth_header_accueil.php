...
<html>
  <head>
      ...
      <link rel="stylesheet" href="../Public/CSS/DiagHealth_header_accueil.css">
  </head>
      ...
      <div class="header">
          ...
          <div class="container">
              <div class="header_navbar">
                  ...
                  <div class="header_navbar_menu">
                      ...
                      ?>
                        <ul class="ul">
                          <li class="li">
                            <a href="DiagHealth_connexion.php" class="header_menu_link"><i class="fab fa-expeditedssl"></i> Mon compte</a>
                          </li>
                          <li class="li">
                            <a href="DiagHealth_connexion.php" class="header_menu_link"><i class="fab fa-expeditedssl"></i> Mes données</a>
                          </li>
                          <?php
                      }
                      ?>
                      ...
                      ?>
                        <ul class="ul">
                          <li class="li">
          	                 <a href="DiagHealth_MonCompte.php" class="header_menu_link"><i class="fas fa-user-circle"></i> Mon compte</a>
                          </li>
                          <?php
                      }
                      ?>
                      ...
                      if(isset($_SESSION['role'])) {
                        ...
                        ?>
                          <li class="li">
                            <a href="DiagHealth_donnees.php" class="header_menu_link"><i class="fas fa-poll"></i> Mes données</a>
                          </li>
                          <?php
       			            }
       			          }
                      ...
                      if(isset($_SESSION['role'])) {
                        ...
                        ?>
                          <li class="li">
                            <a href="DiagHealth_gestion_gest.php" class="header_menu_link"><i class="fas fa-users"></i> Gestion des utilisateurs</a>
                          </li>
                          <?php
       			            }
       			          }
                        ...
                        ?>
                          <li class="li">
                            <a href="DiagHealth_gestion_admin.php" class="header_menu_link"><i class="fas fa-users"></i> Gestion des utilisateurs</a>
                          </li>
                          <?php
       			            }
       			          }
      		            ?>
                      <li class="li">
                        <a class="header_menu_link"><i class="fas fa-globe-europe"></i> Langue</a>
                        <ul class="ul">
                          <li class="li"><a class="header_menu_link">Français</a></li>
                          <li class="li"><a href="en_DiagHealth_<?= $_SESSION['page']; ?>.php" class="header_menu_link">Anglais</a></li>
                        </ul>
                      </li>
        		          <?php
                      if(!isset($_SESSION['role'])) {           
                      ?>
                        <li class="li">
                          <a href="DiagHealth_connexion.php" class="header_menu_link_co"><i class="fas fa-key"></i> Connexion/Inscription</a>
                        </li>
                      </ul>
                      <?php
       			          }
                    ...
                    if(isset($_SESSION['role'])) {
                      ...
                      <li class="li">
                        <form method="post" name="deconnexion">
                          <a class="header_menu_link_co"><i class="fas fa-sign-out-alt"></i><input type="submit" name="deconnexion" class="deco" value="Se déconnecter"></a>
                        </form>
                      </li>
                      <?php	
                    }
              ...
              <div class="header_slogan">
                  <h1 class="h_slogan_title">Teste tes capacités</h1>
              </div>
          </div>
      </div>
