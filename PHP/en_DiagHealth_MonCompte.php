	...
	if(isset($_POST['ajout'])){
		if($dataCompte['centre'] != '0') {
			if($dataCompte['testDemande'] == '0') {
				...
				$msg = "You are already waiting for a test.";
			}
		}
		else {
			$msg = "You must belong to a testing center to apply.";
		}
	}
...
<html>
	...
	<body>
		...
		<h1> My account / my personal information </h1>
		<div id="tableau" align="center">
			...
			<div id="bouton">
				<form id="ajouter" name="ajouter" method="post">
					<input type="submit" class="ajout" name="ajout" onclick="return confirmDemande()" value="Request a test">
				</form>
			</div>
		</div>	
	</body>
