...
<html>
	...
	<body>
		<div class="terminer">
			<a href="DiagHealth_faq.php" id="terminer">Complete changes</a>
		</div>
				...
				while ($numero_faq < $max_faq + 1) {
					...
					if ($datafaq['question'] != '') {
						...
						<div id="<?=$datafaq['idFAQ']?>" style="display:none;">
							...
							<a class="annuler_modif" onclick="out(<?=$datafaq['idFAQ']?>); over('v_<?=$datafaq['idFAQ']?>');">Remove edit mode</a>
							
						</div>
						</div>
						<div class="modif">
								<a onclick="over(<?=$datafaq['idFAQ']?>); out('v_<?=$datafaq['idFAQ']?>');"><i class="far fa-edit"></i> Edit</a>
						</div>
						<div class="selection">
		...
		<a class="modifs"><i class="far fa-save"></i><input type="submit" class="modification" name="modification" value="Save the modifications"></a>
		<a class="suppr" onclick="over('overlay');"><i class="fas fa-trash-alt"></i> Delete</a>
		<!-- Supprimer un élément -->
		<div id="overlay" style="display: none;">
        	<div id="popup">
           		<h2 class="popup_titre">Deleting items</h2>
            	<p class="popup_msg">Are you sure you want to delete these items ?</p>
            	<div align="center">
                	<input type="submit" name="validation" class="popup_lien" value="Delete">	
                	<input type="submit" name="annulation" class="popup_lien" value="Cancel">  		
                </div>
            </div>
        </div>
		</form>
		<h2>Add a question/answer</h2>
		<form action="en_DiagHealth_faq_admin.php" method="post">
			<table>
				<tr>
					<td class="colonne1">
						Question :  
					...
					<td class="colonne2">
						<input type="text" name="question" class="insert_question" placeholder=" Insert a question" required>
					</td>
				</tr>
				<tr class="espace"><tr>
				<tr>
					...
					<td class="colonne2">
						<textarea name="reponse" class="insert_reponse" placeholder=" Insert an answer" required></textarea>
					</td>
				</tr>
				<tr>
					<td><td align="right">
						<input type="submit" class="ajout" name="creer" value="Add">
					</td>
				</tr>
			</table>
		</form>
