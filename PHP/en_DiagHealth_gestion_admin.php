					...
					if (in_array("$Mail", $mailindatabase,true) || in_array("$Mail", $mailindatabase2,true)) {
						...
						<div id="overlay">
							<div id="popup">
								...
								<p class="popup_msg">The member has been added.</p>
								<div align="center">
									<a class="popup_lien" href="DiagHealth_gestion_admin.php">Return</a>
									<a class="popup_lien" href="DiagHealth_accueil.php">Home</a>
								</div>
							</div>
						</div>
						<?php 
...
<html>
	...
	<body>
		<h1>Welcome <?= $_SESSION['prenom']; ?> on your administrator account</h1>
		...
		<div id="ajouter_membre_banniere">
			<div class="banniere" onclick="over('ajouter_membre'); out('ajouter_membre_banniere')">
				<div class="titre_banniere">
					<h3 class="banniere_contenu">Add user</h3>
					...
					<table class="ajouter_utilisateurs_table">
						<tr class="ajouter_utilisateurs_tr">
							...
							<td class="ajouter_utilisateurs_td_input">
								<input type="radio" name="genre" value='0' required><label>Mrs.</label>
								<input type="radio" name="genre" value='1' required><label>Mr.</label>
							</td>
						</tr>
						<tr class="ajouter_utilisateurs_tr">
							<td class="ajouter_utilisateurs_td_titre">
							...
							<td class="ajouter_utilisateurs_td_input">
								<input type="radio" name="role" value='Utilisateur' required><label>User</label>
								<input type="radio" name="role" value='Gestionnaire' required><label>Manager</label>
								<input type="radio" name="role" value='Administrateur' required><label>Administrator</label>
							</td>
						</tr>
						<tr class="ajouter_utilisateurs_tr">
							<td class="ajouter_utilisateurs_td_titre">
						...
						<tr class="ajouter_utilisateurs_tr">
							<td><td>
								<input type="submit" id="inscription" class="inscription" name="inscription" value="Register this member">
							</td>
						</tr>
					</table>
				</form>
				...
				<div id="tableau" align="center">
					...
					<table class="recherche_table">
						<tr class="recherche_tr">
							...
							<th class="recherche_th">Test center</th>
		...
		<div id="gestion_centre_banniere">
			<div class="banniere" onclick="over('gestion_centre'); out('gestion_centre_banniere')">
				<div class="titre_banniere">
					<h3 class="banniere_contenu">Manage test centers</h3>
					<div class="sigle" align="right">
						<h3 class="banniere_contenu2"><i class="fas fa-chevron-right"></i></h3>
					</div>
				</div>
		...
		<div id="gestion_centre" style="display: none;">
			...
			<div id="supprimer_centre_banniere">
				<div class="banniere_centre" onclick="over('supprimer_centre'); out('supprimer_centre_banniere')">
					<div class="titre_banniere">
						<h3 class="banniere_contenu">Delete a center</h3>
						<div class="sigle" align="right">
							<h3 class="banniere_contenu2"><i class="fas fa-chevron-right"></i></h3>
						</div>
					</div>
						...
						<table class="supprimer_centre_table">
							...
							<tr class="supprimer_centre_tr">
								<td class="supprimer_centre_td"><td class="supprimer_centre_td">
									<input type="submit" id="suppression" name="validation" value="Delete">
								</td>
							</tr>
						</table>
					</form>
			...
			<div id="ajouter_centre_banniere">
				<div class="banniere_centre" onclick="over('ajouter_centre'); out('ajouter_centre_banniere')">
					<div class="titre_banniere">
						<h3 class="banniere_contenu">Add a center</h3>
						<div class="sigle" align="right">
							<h3 class="banniere_contenu2"><i class="fas fa-chevron-right"></i></h3>
						</div>
					</div>
						...
						<table class="ajouter_centre_table">
							<tr class="ajouter_centre_tr">
								...
								<td class="ajouter_centre_td_input">
									<input type="text" name="ville" placeholder="City's name" required>
								</td>
							</tr>
							<tr class="ajouter_centre_tr">
								<td class="ajouter_centre_td_titre">
								...
								<td class="ajouter_centre_td_input">
									<input type="text" name="code" placeholder="City's postcode" required>
								</td>
							</tr>
							<tr class="ajouter_centre_tr">
								<td class="ajouter_centre_td_titre">
								...
								<td class="ajouter_centre_td_input">
									<input type="text" name="map" placeholder="Link Google Map" required>
								</td>
							</tr>
							<tr class="ajouter_centre_tr">
							<td><td>
								<input type="submit" id="ajout_centre" class="ajout_centre" name="ajout_centre" value="Add a test center">
							</td>
						</tr>
						</table>
					</form>
