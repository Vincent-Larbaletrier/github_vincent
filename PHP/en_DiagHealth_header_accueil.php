	      ...
	      <div class="header">
	          ...
	          <div class="container">
	              <div class="header_navbar">
	                  ...
	                  <div class="header_navbar_menu">
	                      ...
	                      ?>
	                        <ul class="ul">
	                          <li class="li">
	                            <a href="en_DiagHealth_connexion.php" class="header_menu_link"><i class="fab fa-expeditedssl"></i> My account</a>
	                          </li>
	                          <li class="li">
	                            <a href="en_DiagHealth_connexion.php" class="header_menu_link"><i class="fab fa-expeditedssl"></i> My data</a>
	                          </li>
	                          <?php
	                      }
	                      ?>
	                      ...
	                      ?>
	                        <ul class="ul">
	                          <li class="li">
	          	                 <a href="en_DiagHealth_MonCompte.php" class="header_menu_link"><i class="fas fa-user-circle"></i> My account</a>
	                          </li>
	                          <?php
	                      }
	                      ?>
	                      ...
	                      if(isset($_SESSION['role'])) {
	                        ...
	                        ?>
	                          <li class="li">
	                            <a href="en_DiagHealth_donnees.php" class="header_menu_link"><i class="fas fa-poll"></i> My data</a>
	                          </li>
	                          <?php
	       			            }
	       			          }
	                      ...
	                      if(isset($_SESSION['role'])) {
	                        ...
	                        ?>
	                          <li class="li">
	                            <a href="en_DiagHealth_gestion_gest.php" class="header_menu_link"><i class="fas fa-users"></i> User management</a>
	                          </li>
	                          <?php
	       			            }
	       			          }
	                        ...
	                        ?>
	                          <li class="li">
	                            <a href="en_DiagHealth_gestion_admin.php" class="header_menu_link"><i class="fas fa-users"></i> User management</a>
	                          </li>
	                          <?php
	       			            }
	       			          }
	      		            ?>
	                      <li class="li">
	                        <a class="header_menu_link"><i class="fas fa-globe-europe"></i> Language</a>
	                        <ul class="ul">
	                          <li class="li"><a href="DiagHealth_<?= $_SESSION['page']; ?>.php" class="header_menu_link">French</a></li>
	                          <li class="li"><a class="header_menu_link">English</a></li>
	                        </ul>
	                      </li>
	        		          <?php
	                      if(!isset($_SESSION['role'])) {           
	                      ?>
	                        <li class="li">
	                          <a href="en_DiagHealth_connexion.php" class="header_menu_link_co"><i class="fas fa-key"></i> Login/Register</a>
	                        </li>
	                      </ul>
	                      <?php
	       			          }
	                    ...
	                    if(isset($_SESSION['role'])) {
	                      ...
	                      <li class="li">
	                        <form method="post" name="deconnexion">
	                          <a class="header_menu_link_co"><i class="fas fa-sign-out-alt"></i><input type="submit" name="deconnexion" class="deco" value="Sign out"></a>
	                        </form>
	                      </li>
	                      <?php	
	                    }
	              ...
	              <div class="header_slogan">
	                  <h1 class="h_slogan_title">Test your abilities</h1>
	              </div>
	          </div>
	      </div>
